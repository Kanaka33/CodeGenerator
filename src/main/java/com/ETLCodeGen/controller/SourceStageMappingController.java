...
import java.util.ArrayList;
	...
	public class SourceStageMappingController {
	    ...
	    public Source getSourceForSharedFolder(String filePath, String cbuName) {
	        ...
	        String ownerName = readExcelController.getCellValue(filePath, "Session Properties", 44, "C");
	        Source source = new Source("", sourceType, sourceName, "", sourceTableName, 1, ownerName, 1);
	        int emptyCount = 0;
	        int count = 0;
	        ...
	        for (int i = 26; ; i++) {
	            ...
	            if (columnName == null || columnName.isEmpty()) {
	                emptyCount++;
	                    ...
	                    if (dataType.equalsIgnoreCase("date") || dataType.equalsIgnoreCase("Timestamp")|| dataType.equalsIgnoreCase("DATS")|| dataType.equalsIgnoreCase("TIMS")  ) {
		                    dataType = "date/time";
		                } else if (dataType.equalsIgnoreCase("integer") || dataType.equalsIgnoreCase("int") || dataType.equalsIgnoreCase("DEC") || dataType.equalsIgnoreCase("NUMC") || dataType.equalsIgnoreCase("number(p,s)") || dataType.equalsIgnoreCase("number") || dataType.equalsIgnoreCase("numeric")) {
		                    dataType = "decimal";
		                } else if (dataType.equalsIgnoreCase("BIT") || dataType.equalsIgnoreCase("LANG") || dataType.equalsIgnoreCase("varchar2") || dataType.equalsIgnoreCase("CLNT")) {
		                	dataType = "string";
		                }else if (dataType.equalsIgnoreCase("NVARCHAR") || dataType.equalsIgnoreCase("NCHAR") || dataType.equalsIgnoreCase("NTEXT") || dataType.equalsIgnoreCase("CHAR")) {
		                    dataType = "string";
		                }else if(dataType.equalsIgnoreCase("Float")) {
		                	dataType = "double";
		                }
	        ...
	        for (int i = 26; ; i++) {
	            ...
	            if (columnName == null || columnName.isEmpty()) {
	                ...
	                if (dataType.equalsIgnoreCase("date") || dataType.equalsIgnoreCase("Timestamp")|| dataType.equalsIgnoreCase("DATS")|| dataType.equalsIgnoreCase("TIMS")  ) {
	                    ...
	                    dataType = "decimal";
	                } else if (dataType.equalsIgnoreCase("BIT") || dataType.equalsIgnoreCase("CHAR") || dataType.equalsIgnoreCase("varchar2") || dataType.equalsIgnoreCase("CLNT")) {
	                	dataType = "string";
	                }else if (dataType.equalsIgnoreCase("NVARCHAR") || dataType.equalsIgnoreCase("NCHAR") || dataType.equalsIgnoreCase("NTEXT")) {
	                    dataType = "string";
	                }else if(dataType.equalsIgnoreCase("Float")) {
	                	dataType = "double";
	                }
	                ...
	                if(toDate.equalsIgnoreCase("D")) {
	                	...
	                	iTransformField.setExpression("IIF(TO_CHAR(" + columnName + ")=&apos;0&apos;,NULL,TO_DATE(TO_CHAR(" + columnName + "),&apos;YYYYMMDD&apos;))");
	        ...
	        for (int i = 58; ; i++) {
	            if (!readExcelController.getCellValue(filePath, "Session Properties", i, "B").isEmpty()) {
	                ...
	                if (value.equalsIgnoreCase("Source Definition")) {
	                		Shortcut shortcut = new Shortcut("", sourceName, cname, key, value, "SOURCE", sourceName, "LOCAL", sourceTableName, repoName, "1");
	                        list.add(shortcut);
	                    }
	                if (value.equalsIgnoreCase("Target Definition")) {
	                		Shortcut shortcut2 = new Shortcut("", cname, key, value, "TARGET", "LOCAL", stgTableName, repoName, "1");
	                		list.add(shortcut2);
	                }
